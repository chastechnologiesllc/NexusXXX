...
checks = [
    ...
    ("cache-busted runtime bundle reference exists", (ROOT / "js/app.js").exists() and 'const shareData = { title: video.title, text: shareUrl, url: shareUrl }' in (ROOT / "js/app.js").read_text(encoding="utf-8") and 'app.js?v=nx-share-play2' in (ROOT / "index.html").read_text(encoding="utf-8")),
