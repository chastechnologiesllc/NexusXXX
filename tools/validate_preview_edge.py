...
checks = [
    ...
    ("cache-busted runtime bundle reference exists", (ROOT / "js/app.js").exists() and 'const shareData = { title: video.title, url: shareUrl }' in (ROOT / "js/app.js").read_text(encoding="utf-8") and 'app.js?v=nx-upnext3' in (ROOT / "index.html").read_text(encoding="utf-8")),
