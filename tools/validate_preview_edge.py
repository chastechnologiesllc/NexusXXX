...
checks = [
    ...
    ("edge metadata uses versioned same-origin play-overlay URL", 'previewImageUrl' in edge and '/preview-image?url=' in edge and '&v=play2' in edge),
    ...
    ("dynamic fallback uses centered-play preview URL", '/preview-image?url=' in template and 'v=play2' in template and 'image/png' in template and 'content="640"' in template and 'content="480"' in template),
    ...
    ("static generator uses versioned play-overlay PNG metadata", '&v=play2' in generator and 'image/png' in generator and 'content="640"' in generator and 'content="480"' in generator and 'video thumbnail with play button' in generator),
    ...
    ("share URL uses current preview cache version", 'params.set("nx_preview", "5")' in app),
    ("edge response carries current preview build marker", 'x-nexus-preview-version' in edge and 'share-play-overlay-5' in edge),
